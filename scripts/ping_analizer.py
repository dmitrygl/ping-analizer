...
for line in f:
        ...
        ping = subprocess.call(['ping', '-c', '3', ipaddr], stdout=subprocess.DEVNULL)
        ...
        if ping == 0:
                ...
                if macArg1 != -1:
                        ...
                        if macArg1 - macArg2 < 50:
                                ...
                                print(spanOpenOk, namedev, sep, ipaddr, sep, spanOpenBad, mac, spanClose, sep, sep, sep, ok, spanClose, newLine)
                else:
